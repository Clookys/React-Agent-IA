...
### [modern-homepage-react](./modern-homepage-react/README.md)

**What:** A standalone React + Vite demo for a modern homepage.

**The scenario:** You want a fast starting point for a polished landing page with a strong hero, responsive sections, layered visuals, and accessible defaults.

**What is included:**

- React app structure with Vite
- Modern homepage composition with CTA, metrics, features, and process blocks
- Mobile-friendly layout and reduced-motion support
- A visual direction that avoids generic default styling
